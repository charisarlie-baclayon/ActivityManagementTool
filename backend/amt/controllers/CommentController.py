...
from amt.serializers import CommentSerializer, CreateCommentSerializer, CommentForActivitySerializer
...
class CommentController(GenericViewSet, ListModelMixin, RetrieveModelMixin, CreateModelMixin, UpdateModelMixin, DestroyModelMixin):
    ...
    def get_serializer_class(self):
        ...
        elif self.action == 'comments_for_activity':
            return CommentForActivitySerializer
        else:
