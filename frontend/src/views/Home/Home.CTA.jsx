      ...
      <div className='container cta-content'>
        <div className='d-flex flex-column gap-3 align-items-center'>
          ...
          <div className='row cta-buttons'>
            <div className='col'>
              <button className='btn fw-bold text-fs-4 bw-2 btn-dark btn-block'>Get Started</button>
            </div>
            <div className='col'>
              <button className='btn fw-bold text-fs-4 bw-2 btn-outline-dark btn-block' onClick={handleScrollToTop}>Back to Top</button>
            </div>
          </div>
        </div>
      </div>
