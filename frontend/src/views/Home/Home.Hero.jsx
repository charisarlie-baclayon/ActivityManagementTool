      ...
      <div className="container">
        <div className="row">
              ...
              <div className="col-md mb-3">
                <div className="card border">
                  <div className="card-body">
                    ...
                    <button className="btn w-100 bw-2 btn-outline-dark">Learn More</button>
                  </div>
                </div>
              </div>
              <div className="col-md mb-3">
                <div className="card bg-dark text-white">
                  <div className="card-body">
                    ...
                    <button className="btn w-100 bw-2 btn-outline-light">Learn More</button>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="col-md d-flex justify-content-center align-items-center"> {/* Use d-flex, justify-content-center, and align-items-center */}
            <div>
              <img src={hero_image} alt="hero-section-woman" className="img-fluid" />
            </div>
          </div>
        </div>
      </div>
