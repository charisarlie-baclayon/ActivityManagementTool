        ...
        <div className="team-section">
            <div className='container team-content'>
                <div className=' d-flex flex-column gap-3 '>
                    <h1 className='text-center fw-bold '>Meet the <span className='text-secondary'>Team</span></h1>
                ...
                <div className='row justify-content-around gap-3 '>
                    <div className='col-md-3'>
                        <div className=' d-flex flex-column align-items-center text-center'>
                            ...
                            <p className='text-fs-5'>Lorem ipsum dolor sit amet, consectetur adipiscing elit</p>
                        </div>
                    </div>
                    <div className='col-md-3'>
                        <div className=' d-flex flex-column align-items-center  text-center'>
